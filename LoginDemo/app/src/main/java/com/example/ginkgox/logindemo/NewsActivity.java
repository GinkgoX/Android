...
public class NewsActivity extends AppCompatActivity implements View.OnClickListener {
    private TextView item_detail, item_category_report, item_tech;
    ...
    private void initViews() {
        ...
        item_tech = (TextView)findViewById(R.id.item_tech);

        item_detail.setOnClickListener(this);
        item_category_report.setOnClickListener(this);
        item_tech.setOnClickListener(this);
