...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] name = new String[] { "张国荣", "张学友", "谭咏麟", "朴树" };
        final String[] message = new String[] {
                ...
                "朴树，歌手、演员，1961年7月10日出生于香港，1984年获得香港首届十八区业余歌唱大赛冠军，正式出道，1993年发行的国语唱片《吻别》年度销量超过400万张，1995年、1996年连续两年获得世界音乐大奖全球销量最高亚洲流行乐歌手奖"};
        final int[] photo = new int[] { R.drawable.move1, R.drawable.move2, R.drawable.move3, R.drawable.move4 };
        List<Map<String, Object>> data = new ArrayList<Map<String, Object>>();

        Map<String, Object> map1 = new HashMap<String, Object>();
        map1.put("photo", R.drawable.move1);
        map1.put("name", name[0]);
        data.add(map1);

        Map<String, Object> map2 = new HashMap<String, Object>();
        map2.put("photo", R.drawable.move2);
        map2.put("name", name[1]);
        data.add(map2);

        Map<String, Object> map3 = new HashMap<String, Object>();
        map3.put("photo", R.drawable.move3);
        map3.put("name", name[2]);
        data.add(map3);

        Map<String, Object> map4 = new HashMap<String, Object>();
        map4.put("photo", R.drawable.move4);
        map4.put("name", name[3]);
        data.add(map4);

        Lv.setAdapter(new SimpleAdapter(this, data, R.layout.list_item,new String[] { "photo", "name" }, new int[] { R.id.iv,R.id.tv_name }));
